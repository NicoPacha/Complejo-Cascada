...
public class dtoEmpleadosTipoMan {
    ...
    public dtoEmpleadosTipoMan() {
    }

    public dtoEmpleadosTipoMan(int id_empleado, int id_tipo_mantenimiento, String tipo_mantenimiento, String nombreCompleto, long telefono, long documento, String direccion, String tipo_edilicio) {
    ...
    public dtoEmpleadosTipoMan(int id_tipo_mantenimiento, String tipo_mantenimiento, String nombreCompleto, long telefono, long documento, String direccion, String tipo_edilicio) {
        this.id_tipo_mantenimiento = id_tipo_mantenimiento;
        this.tipo_mantenimiento = tipo_mantenimiento;
        this.nombreCompleto = nombreCompleto;
        this.telefono = telefono;
